...
static boolean_T state_not_empty_main = false;
...
real_T b_eml_rand_mt19937ar_stateful(const emlrtStack *sp)
{
  ...
  b_st.tls = st.tls;
  st.site = &ge_emlrtRSI;
  memcpy(&b_state[0], &(*state_ptr)[0], 625U * sizeof(uint32_T));
  b_st.site = &he_emlrtRSI;
  r = genrandu(&b_st, b_state);
  memcpy(&(*state_ptr)[0], &b_state[0], 625U * sizeof(uint32_T));
  return r;
}
...
void c_eml_rand_mt19937ar_stateful_f(const emlrtStack *sp)
{
  ...
  int32_T c_eml_rand_mt19937ar_stateful_f_numThreads;
  int32_T i;
  int32_T ub_loop;
  ub_loop = omp_get_max_threads();
  emlrtEnterParallelRegion((emlrtCTX)sp, omp_in_parallel());
  emlrtPushJmpBuf((emlrtCTX)sp, &emlrtJBStack);
  c_eml_rand_mt19937ar_stateful_f_numThreads = emlrtAllocRegionTLSs(
      sp->tls, omp_in_parallel(), omp_get_max_threads(), omp_get_num_procs());
#pragma omp parallel for schedule(static)                                      \
    num_threads(c_eml_rand_mt19937ar_stateful_f_numThreads)
...
#pragma omp parallel num_threads(                                              \
    c_eml_rand_mt19937ar_stateful_i_numThreads) private(emlrtJBEnviron, c_st)  \
...
#pragma omp for schedule(static)
  ...
  emlrtPopJmpBuf((emlrtCTX)sp, &emlrtJBStack);
  emlrtExitParallelRegion((emlrtCTX)sp, omp_in_parallel());
  memcpy(&state_main[0], &state[0], 625U * sizeof(uint32_T));
  b_st.site = &pg_emlrtRSI;
  eml_rand_mt19937ar(&b_st, state);
  state_not_empty = true;
}
...
void eml_rand_mt19937ar_stateful(const emlrtStack *sp, int64_T varargin_1,
                                 emxArray_real_T *r)
{
  static const real_T dv[257] = {0.0,
                                 0.215241895984875,
                                 0.286174591792068,
                                 0.335737519214422,
                                 0.375121332878378,
                                 ...
                                 3.65415288536101,
                                 3.91075795952492};
  static const real_T dv1[257] = {1.0,
                                  0.977101701267673,
                                  0.959879091800108,
                                  0.9451989534423,
                                  0.932060075959231,
  ...
  c_st.tls = b_st.tls;
  if (!(varargin_1 >= 0.0)) {
    emlrtNonNegativeCheckR2012b((real_T)varargin_1, &tb_emlrtDCI,
                                (emlrtConstCTX)sp);
  }
  i = r->size[0];
  ...
  for (k = 0; k < i; k++) {
    real_T b_r;
    st.site = &rb_emlrtRSI;
    memcpy(&mt[0], &(*state_ptr)[0], 625U * sizeof(uint32_T));
    ...
    do {
      exitg1 = 0;
      genrand_uint32_vector(mt, u32);
      b_i = (int32_T)((u32[1] >> 24U) + 1U);
      b_r = (((real_T)(u32[0] >> 3U) * 1.6777216E+7 +
              (real_T)((int32_T)u32[1] & 16777215)) *
                 2.2204460492503131E-16 -
             1.0) *
            dv[b_i];
      if (muDoubleScalarAbs(b_r) <= dv[b_i - 1]) {
        exitg1 = 1;
      } else if (b_i < 256) {
        real_T u;
        c_st.site = &tb_emlrtRSI;
        u = genrandu(&c_st, mt);
        if (dv1[b_i] + u * (dv1[b_i - 1] - dv1[b_i]) <
            muDoubleScalarExp(-0.5 * b_r * b_r)) {
          exitg1 = 1;
        }
      } else {
        real_T u;
    ...
    r_data[k] = b_r;
    memcpy(&(*state_ptr)[0], &mt[0], 625U * sizeof(uint32_T));
  }
}
