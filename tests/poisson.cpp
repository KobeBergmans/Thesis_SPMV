...
BOOST_AUTO_TEST_CASE(powermethod_size_5_5, * boost::unit_test::tolerance(std::pow(10, -10))) {
    int mat_size = 5*5;
...
BOOST_AUTO_TEST_CASE(powermethod_size_10_5, * boost::unit_test::tolerance(std::pow(10, -10))) {
    int mat_size = 10*5;
